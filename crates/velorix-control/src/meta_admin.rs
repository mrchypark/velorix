...
pub use velorix_meta::{
    ...
    RelationIngestCapability, RelationIngestPartitionCutV1, RelationIngestPublicationRefV1,
    RelationIngestSourceCutV1, ReserveIngestRangeOutcome, StandingRuntimeCheckpointPointer,
